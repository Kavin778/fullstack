    ...
    return(
      ...
      <div className="bg-white sm:p-6 p-4 lg:p-8 border-indigo-900 border-4 rounded-lg shadow-lg w-full max-w-lg ">
         <div class="md:flejustify-center">
             ...
             <p class="mt-2 text-gray-500 hover:text-indigo-900">KAVIN M 
             </p>
             <p class="mt-2 text-gray-500 hover:text-indigo-900">Student at Bannari Amman Institute of Technology  
             </p>
