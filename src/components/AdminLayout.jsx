    ...
    <div className="flex h-screen ">
      ...
      <main className="flex-1 overflow-auto sm:ml-72 lg:ml-72 bg-white">
        ...
        <div className="w-full rounded-lg md:w-1/2 h-48 mb-4 text-center flex flex-col border-2 border-indigo-900 hover:bg-indigo-800 hover:text-white justify-top items-center">
            <h2 className="m-8 text-xl lg:text-3xl md:text-2xl sm:text-xl font-semibold">To Approve </h2>
            <h2 className="xl:text-6xl text-2xl lg:text-5xl md:text-4xl sm:text-2xl font-semibold">3</h2>
          </div>
          <div className="w-full rounded-lg md:w-1/2 h-48 mb-4 text-center flex flex-col border-2 border-indigo-900 hover:bg-indigo-800 hover:text-white justify-top items-center">
            <h2 className="m-8 lg:text-3xl text-xl md:text-2xl sm:text-xl font-semibold">Rejected Bookings </h2>
            <h2 className="xl:text-6xl text-2xl lg:text-5xl md:text-4xl sm:text-2xl font-semibold">2</h2>
          </div>
          <div className="w-full rounded-lg md:w-1/2 h-48 mb-4 text-center flex flex-col border-2 border-indigo-900 hover:bg-indigo-800 hover:text-white justify-top items-center">
            <h2 className="m-8 text-xl lg:text-3xl md:text-2xl  sm:text-xl font-semibold">Total Bookings</h2>
            <h2 className="xl:text-6xl text-2xl lg:text-5xl md:text-4xl sm:text-2xl font-semibold">5</h2>
          </div>
        </div>
      </main>
      {/* VenueForm Modal */}
